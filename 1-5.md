...
* **abdicate** the throne/ abdicate responsibility
    ...
    * 逃避
* **aberrant** habits
    * deviant from normal standard
* **abet** someone's opinion
    * encourage or assist (especially something bad)
...
* an **abstemious** diet
    * ascetic/temperate
* **recondite**/**esoteric**/**arcane**/**cryptic**/**abstruse**/**esoteric** <-> **exoteric**
...
* The sophisticated **badinage**/**banter**/**repartee** != blandishment
...
* **clarion** call for democracy
    * 嘹亮的
* He is a **clement** teacher/ a **clement** weather <-> inimical
    * tolerant
    * 温和的
* a **clot** of daisies
    * 一簇
